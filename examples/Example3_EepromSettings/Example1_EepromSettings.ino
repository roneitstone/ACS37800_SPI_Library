/*
  Example adapted from SparkFun ACS37800 Example3_EepromSettings.
  Original example by SparkFun Electronics.
  Modified by Eduardo Bruno, 2025.

  Changes:
  - Adapted communication from I2C (Wire) to SPI.
  - Removed I2C error flag handling.
  - Adjusted initialization and data reading functions for SPI.
  
  License: MIT (same as original SparkFun ACS37800 library)
...
#include "ACS37800_SPI.h" // Click here to get the library: http://librarymanager/All#SparkFun_ACS37800
...
void setup()
{
  ...
  mySensor.beginSPI(SS_PIN);
  
  
  Serial.println("ACS37800 inicializado com sucesso!");
